    ...
    <div className="card">
      ...
      <div className="card-details">
        ...
        <div className="height">
          {"Height: "}
          {Math.round(pokemonHeight * 10) >= 100
            ? Math.round(pokemonHeight * 0.1) + " m"
            : Math.round(pokemonHeight * 10) + " cm"}
        </div>
        <div className="height">
          {"Weight: "}
          {pokemonWeight / 10 < 1
            ? Math.round(pokemonWeight * 100) + " gm"
            : Math.round(pokemonWeight / 10) + " kg"}
        </div>
      </div>
    </div>
  );
